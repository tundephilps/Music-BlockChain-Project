    ...
    <article className="p-2">
      <figure className="hidden lg:flex w-full lg:max-w-3xl mx-auto  bg-black hover:bg-gradient-to-t hover:from-yellow-700 hover:text-black bg-gradient-to-b from-orange-400/50 rounded-xl p-8 border-4 border-t-yellow-800 border-l-yelloe-800 border-b-yellow-900 border-r-orange-900 text-yellow-800 dark:text-orange-600 transition-all duration-300">
        ...
        <section className="grid grid-cols-[1fr,2fr] lg:gap-x-20">
          ...
          <div className="text-red-900 dark:text-red-600 pt-6 md:p-8  flex justify-center items-center mx-auto w-[460px]   ">
            <div className="font-sans justify-center sm:flex-col sm:text-center  ">
              <h1 className="lg:text-4xl text-3xl  font-black mx-auto ">
                Sales & Merchandize
              </h1>
              <div className="flex   mt-2">
                <FaShoppingBag className="h-8 w-8 mx-auto " />
              </div>
            </div>
          </div>
        </section>
