...
const MobileAds = () => {
  return (
    <>
      <section>
        <div className="mx-auto lg:py-10 w-full max-w-7xl px-5 pt-16 md:px-10 md:pt-24 lg:pt-32">
          <div className="grid gap-16 md:grid-cols-2 md:gap-4 lg:grid-cols-[1fr_550px_1fr]">
            <div
              data-aos="fade-right"
              data-aos-offset="300"
